...
function keypairFromBase58(privateKeyBase58) {
    try {
...
const keypair = keypairFromBase58(address_1.PRIVATE_KEY);
const mintTokens = (fromAddress, amount) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, spl_token_1.mintTo)(connection, keypair, new web3_js_1.PublicKey(address_1.TOKEN_MINT_ADDRESS), new web3_js_1.PublicKey(fromAddress), keypair, amount);
